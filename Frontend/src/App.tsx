      ...
      <div className="rounded-xl border bg-card border-zinc-800 shadow w-full w-[40vw] justify-center px-4 ">
        <div>
          <div className="flex items-center ">
            ...
            <div className="text-white text-3xl  mt-4 ibm-plex-mono-bold">
              Real Time Chat
            </div>
          </div>
          <div className="text-zinc-600 ibm-plex-mono-medium pl-2 mb-2">
            temporary room that expires after all users exit
          </div>
          <div
            className="text-zinc-600 h-10 ibm-plex-mono-medium
         rounded-lg bg-zinc-900 pl-4 flex items-center "
          >
            Room Code: RED
            <DuplicateIcon />
            <div></div>
          ...
          {message.map((message) => (
            <div className="m-4">
              ...
              px-3 py-2 inline-block rounded-lg mt-0.5 ibm-plex-mono-medium
               textContainer tracking-widest leading-none "
              >
                {message}
              </span>
            </div>
        ...
        <div className=" flex  align-center ">
          ...
          w-full bg-zinc-900 rounded-md border-zinc-800"
